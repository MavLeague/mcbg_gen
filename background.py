...
keyboard = Controller()
InfoText = "1. Set the Resolution of your Instance to a 1:1 Ratio (e.g. 512x512; 1024x1024). \n2. Make sure your Instance is in Window Mode! \n3. Set your FOV to 82. \n4. (Open your World and) Go to a suitable place. This will be the Center of your Background! \n5. Press the \"Take Screenshots\"-Button and wait 7 Seconds! \n6. Open your Screenshots-Folder. Then Drag and Drop the taken Screenshots in order in the \"Source\"-Inputs so the Path appears in it. \n7. Choose the Background Folder in your Resourcepack and Drag and Drop it in the \"Target File\"-Input so the Path appears in it. \n8. Click \"Create Files\" and the files should appear in the chosen Folder."
